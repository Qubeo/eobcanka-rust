...
fn main() {   
    ...
    let eOP_card: mycard::MyCard = mycard::MyCard::new();
    let app_result = eOP_card.select_application(mycard::MyCard::APP_ID_CARD_MANAGEMENT.to_vec());

    let card_number = eOP_card.get_card_number();
...
// TODO: Implement within the MyCard struct
/// @get_file
